...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemClickListener{
    ...
    private void hideview(){
        ...
        set.playTogether(
                ...
                ObjectAnimator.ofFloat(show_content, "translationX", 0, dip2px(50)),
                ObjectAnimator.ofFloat(title_text_1, "translationX", 0, dip2px(90)),
                ObjectAnimator.ofFloat(title_text_0, "translationX", 0, dip2px(50)),
    ...
    private void showview(){
        ...
        set.playTogether(
                ...
                ObjectAnimator.ofFloat(show_content, "translationX", dip2px(50),0),
                ObjectAnimator.ofFloat(title_text_1, "translationX",dip2px(90),0),
                ObjectAnimator.ofFloat(title_text_0, "translationX",dip2px(50),0),
